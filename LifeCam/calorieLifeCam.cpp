...
//------------------Google Cloud Init------------------>
    setupCloudIoT();    //This function also sets up the wifi in which case it's unneccessary to setup the wifi in camera init
    Serial.println("Iot setup done");
}
...
//Constantly pushes telemetry data to the cloud
...
extern "C" void app_main()
{
    ...
    xTaskCreate(mqtt_task, "mqtt_task", 1024*2, NULL, configMAX_PRIORITIES, NULL);
    camera_task();
